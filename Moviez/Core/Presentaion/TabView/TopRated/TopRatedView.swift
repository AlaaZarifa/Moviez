...
struct TopRatedView: View {
    ...
    var body: some View {
        ...
        ScrollView {
                ...
                if viewModel.topRatedMovies.isEmpty {
                    ...
                    ProgressView()
                        ...
                        .onAppear{
                            ...
                            if !isRefreshed {
                            viewModel.fetchMovies(type: .TOP_RATED)
                            }
                        }
                    ...
                    LazyVGrid(columns: columns, spacing: 10) {
                        ...
                        ProgressView()
                            ...
                            .progressViewStyle(.circular)
                            .tint(.blue)
                            .opacity(viewModel.topRatedMovies.isEmpty ? 0.0 : 1.0)
                            .onAppear{
                                // Fetching more data
                                viewModel.loadMoreData(type: .TOP_RATED)
                            }
            ...
            isRefreshed = true
            viewModel.refreshData(type: .TOP_RATED)
        }
